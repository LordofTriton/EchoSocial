...
export default function EchoConversation({ data, control, page }) {
    ...
    const createComment = async () => {
        ...
        if (newCommentMedia) {
            ...
            uploadedFile = await APIClient.post(APIClient.routes.uploadFile, formData, null, { 'Content-Type': "multipart/form-data" });
    ...
    return (
        <>
            ...
            <div className={styles.echoViewerCommentsContainer} style={{ right: !echoData ? "-150vw" : null }}>
